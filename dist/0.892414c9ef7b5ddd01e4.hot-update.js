...
exports.fileDTO = exports.FileWithUrlDto = void 0;
...
const fileWithUrl_dto_1 = __webpack_require__(24);
let FilesService = class FilesService {
    ...
    async findAll(type, offset, limit) {
        ...
        for (const doc of fileInfos.docs) {
            ...
            const dto = fileWithUrl_dto_1.fileDTO(doc, url);
        }
        console.log(fileInfos);
        return Promise.all(fileInfos.docs.map(async (file) => {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a0dc1adfaf6f0d9e27d5")
/******/ })();
/******/ 
/******/ }
;